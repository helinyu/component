...
@property (readonly, copy) XCUIElementQuery *touchBars;// touchbars 的触摸条
@property (readonly, copy) XCUIElementQuery *groups; // 组
@property (readonly, copy) XCUIElementQuery *windows; //窗口
@property (readonly, copy) XCUIElementQuery *sheets; // sheet弹框
@property (readonly, copy) XCUIElementQuery *drawers; // 绘制
