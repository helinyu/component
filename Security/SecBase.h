...
*/
typedef struct CF_BRIDGED_TYPE(id) __SecCertificate *SecCertificateRef; // 证书的引用
...
*/
typedef struct CF_BRIDGED_TYPE(id) __SecKey *SecKeyRef; // 其实就是一个秘钥的引用
// https://danleechina.github.io/iOS-create-SecKeyRef-official-way/
// https://juejin.cn/post/6844903742483988493
...
*/
typedef struct CF_BRIDGED_TYPE(id) __SecPolicy *SecPolicyRef; // 安全的引用
//  https://www.codenong.com/42111010/ 几个对象的解释
