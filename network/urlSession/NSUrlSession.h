...
NSURLSession
NSURLSessionTask // 一个请求的生命周期
NSURLSessionDataTask：NSURLSessionTask // 只是为了区分上传和下载
...
NSURLSessionConfiguration // 配置的类

NSURLSessionDelegate //回话的代理
...
NSURLSessionConfiguration //回话配置

NSURLSessionTaskTransactionMetrics // 矩阵，应该是统计的内容
NSURLSessionTaskMetrics // 回话任务矩阵
