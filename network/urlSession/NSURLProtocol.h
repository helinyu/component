...
//  其实就是给用户实现的一个请求的接口内容， 看看这个内容有些什么东西可以静心处理
...
*/
+ (BOOL)registerClass:(Class)protocolClass; // 注册的协议
...
*/
+ (void)unregisterClass:(Class)protocolClass; // 注销的协议
