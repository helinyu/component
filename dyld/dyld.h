...
// https://juejin.cn/post/6844903778840215560
// 获取某个库链接时和运行时的版本号
/*
 ...
 */
// Note: _NSGetExecutablePath 返回可执行的路径， 可能是一个软连接 ，可能大于MAXPATHLEN。
// 将可执行的拷贝到缓存中， 缓存参数需要初始化缓存的大小。
