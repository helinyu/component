 ...
 */
// mach的头部
// http://www.4k8k.xyz/article/weixin_44060108/117439965 mach-o 里面的结构解释
struct mach_header {
	uint32_t	magic;	 // 魔数	/* mach magic number identifier */
	cpu_type_t	cputype; // cpu的指定类型	/* cpu specifier */
	cpu_subtype_t	cpusubtype;	 //cpu的子类型 /* machine specifier */
	uint32_t	filetype; // 文件烈性	/* type of file */
	uint32_t	ncmds;	 // 命令的数目	/* number of load commands */
	uint32_t	sizeofcmds; // 命令的大小	/* the size of all the load commands */
	uint32_t	flags;	 // 表示	/* flags */
};
...
// libBacktraceRecording.dylib库的使用：https://blog.csdn.net/u011876968/article/details/70168392 
// 
