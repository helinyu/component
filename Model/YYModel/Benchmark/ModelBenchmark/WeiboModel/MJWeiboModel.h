...
@interface MJWeiboPictureMetadata : NSObject <NSCoding>
...
@interface MJWeiboPicture : NSObject <NSCoding>
@property (nonatomic, strong) NSString *picID;
@property (nonatomic, strong) NSString *objectID;
@property (nonatomic, assign) int photoTag;
@property (nonatomic, assign) BOOL keepSize;
@property (nonatomic, strong) MJWeiboPictureMetadata *thumbnail;
@property (nonatomic, strong) MJWeiboPictureMetadata *bmiddle;
@property (nonatomic, strong) MJWeiboPictureMetadata *middlePlus;
@property (nonatomic, strong) MJWeiboPictureMetadata *large;
@property (nonatomic, strong) MJWeiboPictureMetadata *largest;
@property (nonatomic, strong) MJWeiboPictureMetadata *original;
@end

@interface MJWeiboURL : NSObject <NSCoding>
...
@interface MJWeiboUser : NSObject <NSCoding>
...
@interface MJWeiboStatus : NSObject <NSCoding>
//@property (nonatomic, assign) uint64_t statusID;
//@property (nonatomic, strong) NSString *idstr;
//@property (nonatomic, strong) NSString *mid;
//@property (nonatomic, strong) NSString *rid;
//@property (nonatomic, strong) NSDate *createdAt;
//@property (nonatomic, strong) MJWeiboUser *user;
//@property (nonatomic, assign) int32_t userType;
//@property (nonatomic, strong) NSString *text;
//@property (nonatomic, strong) NSArray *picIds;        /// Array<NSString>
//@property (nonatomic, strong) NSDictionary *picInfos; /// Dic<NSString, MJWeiboPicture>
@property (nonatomic, strong) NSArray *urlStruct;     ///< Array<MJWeiboURL>
