 ...
 * Defaults to 0.
 */
@property (nonatomic, assign) NSUInteger sd_optimalFrameCacheSize; // 缓存的大小
 ...
 * Defaults to YES.
 */
@property (nonatomic, assign) BOOL sd_predrawingEnabled; // 提前绘制
 ...
 * Defatuls to YES;
 */
@property (nonatomic, assign) BOOL sd_cacheFLAnimatedImage; // 是否缓存这个图片
 ...
 */
- (void)sd_setImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT; //便利的设置方法
