...
typedef NS_ENUM(NSInteger, SDImageCacheType) {
     ...
     */
    SDImageCacheTypeNone, // 直接从网上下载
    /**
     * The image was obtained from the disk cache.
     */
    SDImageCacheTypeDisk, // 从磁盘缓存中读取
    /**
     * The image was obtained from the memory cache.
     */
    SDImageCacheTypeMemory // 从内存缓存中读取
};
...
typedef NS_OPTIONS(NSUInteger, SDImageCacheOptions) {
     ...
     */
    SDImageCacheQueryDataWhenInMemory = 1 << 0, //访问内存的缓存的时候也读取磁盘的数据
    /**
     ...
     */
    SDImageCacheQueryDiskSync = 1 << 1, // 同步读取磁盘数据
    /**
     * By default, images are decoded respecting their original size. On iOS, this flag will scale down the
     * images to a size compatible with the constrained memory of devices.
     */
    SDImageCacheScaleDownLargeImages = 1 << 2 // 默认解码的是原始的大小， 在iOS中，将图像缩小到与设备受限内存兼容的大小
};
 ...
 */
- (NSUInteger)getSize; // 数字大小

/**
 * Get the number of images in the disk cache
 */
- (NSUInteger)getDiskCount; // 磁盘数目
