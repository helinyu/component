...
@property (nonatomic, strong, readwrite) UIImage *currentFrame; // 当前的帧率
...
@property (nonatomic, assign) BOOL shouldAnimate; // Before checking this value, call `-updateShouldAnimate` whenever the animated image or visibility (window, superview, hidden, alpha) has changed. 判断要不要显示动画
...
- (void)displayDidRefresh:(CADisplayLink *)displayLink
{
    ...
    if (delayTimeNumber != nil) { // 这里是一张一张进行展示的
